...
@section('content_header')
    <h1 class="text-2xl font-bold dark:text-gray-200 text-gray-700 mb-4">Event</h1>
@stop
...
@section('content')
    ...
    <!-- Main modal -->
    @if (session('error'))
        <div id="default-modal" data-modal-target="default-modal" tabindex="-1" aria-hidden="true"
            class="overflow-y-auto overflow-x-hidden flex fixed top-0 right-0 left-0 z-50 justify-center pt-8 w-full md:inset-0 max-h-full bg-black/50 items-center">
            <div id="alert-additional-content-2"
                class="p-4 mb-4 text-red-800 border max-w-[75%] border-red-300 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-800"
                role="alert">
                <div class="flex items-center">
                    ...
                    <h3 class="text-lg font-medium">Can't Add Event</h3>
                </div>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td>
                            <a href="{{ route('event.edit', $item->id) }}"
                                class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-1 px-3 rounded inline-flex items-center">
                            ...
                            <a href="{{ route('event.scan', $item->id) }}"
                                class="bg-gray-500 hover:bg-gray-600 text-white font-bold py-1 px-3 rounded inline-flex items-center">
                                <svg class="w-6 h-w-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
